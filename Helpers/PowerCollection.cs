...
namespace System.Collections.ObjectModel
{
    ...
    /// </summary>
    public class PowerCollection<T> : ObservableCollection<T>
    {
        ...
        public PowerCollection(IEnumerable<T> collection) : base(collection) { }
        ...
        public PowerCollection(List<T> list) : base(list) { }
        ...
        {
            private readonly PowerCollection<T> _collection;
            public DeferredEventsCollection(PowerCollection<T> collection)
            {
